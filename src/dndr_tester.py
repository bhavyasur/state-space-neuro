"""
Tester with one session of data to see if rSLDS works at all.
"""
...
import ssm
from ssm.ssm.util import random_rotation
...
T = 10000
K = 3
D_obs = 10 # determine how many observed dimensions (number of variables)
D_latent = 2
...
q_elbos_lem, q_lem = rslds_lem.fit(y, method="laplace_em",
                               ...
                               initialize=False, num_iters=500, alpha=0.0)
